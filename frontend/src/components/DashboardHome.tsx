                    ...
                    <div className="flex items-center space-x-3">
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                        ...
                        {transaction.type === 'deposit' ? (
                          ...
                          <ArrowUpIcon className="w-5 h-5 text-red-400 rotate-180" />
                        ) : (
